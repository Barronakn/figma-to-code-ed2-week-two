      ...
      <div className="flex flex-row gap-3">
        <div
          ...
          className={`w-1/2 border rounded-xl flex flex-col gap-3 p-3 cursor-pointer ${
            selectedMethod === 'Debit/Credit Card' ? 'border-black' : 'border-gray-150'
          }`}
        >
          <div>
        ...
        <div
          ...
          className={`w-1/2 border rounded-xl flex flex-col gap-3 p-3 cursor-pointer ${
            selectedMethod === 'Virtual account' ? 'border-black' : 'border-gray-150'
          }`}
        >
          <div>
          ...
          <div className="flex flex-row gap-1">
            <input className="bg-black focus:ring-black hover:cursor-pointer" type="checkbox" id="checkbox" />
            <label className="text-xs" htmlFor="#">
              Use shipping address as billing address
            </label>
          </div>

          <div onClick={handleredirect} className="flex flex-row w-full gap-2 mx-auto my-0 justify-center font-semibold cursor-pointer bg-black text-white rounded-4xl text-center fit-element text-sm px-5 md:px-8 md:py-3.5 py-3 border border-gray-150">
